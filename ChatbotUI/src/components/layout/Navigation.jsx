...
const Navigation = ({ open, setOpen }) => {
    ...
    // Auth aur Profile data load karna
    ...
    return (
        ...
        >
            ...
            <nav className="flex flex-col gap-2 px-6">
                ...
                {/* Naya AI Recommended Link yaha add kiya gaya hai */}
                <NavItem to="/recommendations" label="AI Scheduler" onClick={() => setOpen && setOpen(false)} />
            ...
            <footer className="mt-auto border-t border-slate-50 p-10">
                <div className="flex items-center justify-between gap-3 whitespace-nowrap">
                    {isAuthenticated && firstName && (
                        <span className="text-md font-medium text-slate-600 truncate">{firstName}</span>
                    )}
                    <button
                        type="button"
