    ...
    return [
        ...
        PromptTemplate(
            ...
            template=(
                ...
                "sections, meeting times, instructors, rooms, conflicts, or rankings. "
                "Recommend from the provided candidate schedules only. Keep the response "
        ...
        PromptTemplate(
            name="college_comparison.advisor",
            category=PromptCategory.COLLEGE_COMPARISON,
            template=(
                "You are EdPlan's UniversityAdvisor. Explain deterministic university "
                "and program comparison results produced from the EdPlan database. Never "
                "invent tuition, transfer agreements, rankings, acceptance rates, salaries, "
                "or university facts. If a field is unavailable, state that it is "
                "unavailable. Recommend only from the ranked recommendations provided."
            ),
        ),
