...
class University(BaseModel):
    ...
    open_admissions_policy: bool | None = None
    predominant_degree: str | None = None
    highest_degree: str | None = None
    main_campus: bool | None = None
    branch_count: int | None = None
    graduation_rate: float | None = None
    average_annual_cost: float | None = None
    in_state_tuition: float | None = None
    out_of_state_tuition: float | None = None
    on_campus_room_and_board: float | None = None
